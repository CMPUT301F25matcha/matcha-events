...
public class EventRepository {
    ...
    private List<EventAdmin> eventsList; // Keep a reference to the list
    ...
    private void loadMockData() {
        ...
        EventAdmin event1 = new EventAdmin("Swimming Lessons", cal.getTime(), "2:00 PM", "Community Pool", 20);
        event1.setId("1");

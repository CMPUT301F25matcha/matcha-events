...
public class BottomNavigationHelper {
    ...
    public static void setupNavigation(Activity activity, View bottomNavView, NavItem currentItem) {
        LinearLayout homeLayout = bottomNavView.findViewById(R.id.nav_home);LinearLayout qrScannerLayout = bottomNavView.findViewById(R.id.nav_qr_scanner);
        ...
        // Set selected state
        setSelectedItem(currentItem, homeLayout, qrScannerLayout, notificationsLayout, profileLayout);

        // Set click listeners
        setupClickListeners(activity, homeLayout, qrScannerLayout,
    ...
    public static void setSelectedItem(
        ...
        if (homeLayout == null || qrScannerLayout == null
                || notificationsLayout == null || profileLayout == null) {
            // Gracefully bail if bar is missing
            return;
        }
        // Reset all items to unselected state
        resetAllItems(homeLayout, qrScannerLayout, notificationsLayout, profileLayout);
